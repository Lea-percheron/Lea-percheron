# Bonjour, je suis Léa Percheron

Étudiante en informatique, avec un parcours Licence et Master orienté développement logiciel, intelligence artificielle, applications mobiles, NLP, robotique et tests logiciels.

Je développe des projets en Python, Swift, Java, TypeScript, SQL, R et C. Mon GitHub présente des projets académiques et personnels autour des assistants IA, des applications iOS/Android, du traitement automatique du langage, du web, des bases de données et de l'algorithmique.
...
## Ce que j'approfondis actuellement

- Assistants IA et interactions en temps réel.
- Développement mobile iOS et Android.
- NLP et apprentissage automatique appliqué.
- Tests logiciels, architecture propre et qualité de code.
